...
/* Unified card that wraps everything */
...
.card-title{font-size:1.35rem;font-weight:700;color:#111;margin:0 0 .4rem;letter-spacing:-.01em;}
.card-sub{font-size:.85rem;color:#6B7280;line-height:1.6;margin:0 0 1.6rem;}
.section-label{font-size:.65rem;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#9CA3AF;margin-bottom:.5rem;}

/* File uploader — make it big and dashed like reference */
...
[data-testid="stFileUploader"]:hover{border-color:#8B95B0;}
[data-testid="stFileUploaderDropzoneInstructions"]{gap:.4rem;}
[data-testid="stFileUploaderDropzoneInstructions"] > div > small{font-size:.8rem;color:#9CA3AF;}
[data-testid="baseButton-secondary"]{
    background:white!important;border:1px solid #D1D5DB!important;
    color:#374151!important;border-radius:7px!important;
    font-size:.85rem!important;font-weight:500!important;
    padding:.4rem 1rem!important;
}

/* Results card */
.result-card{background:#F8F9FC;border-top:1px solid #E5E7EB;padding:1.5rem 2rem;}
.result-name{font-size:.95rem;font-weight:600;color:#111;margin:0 0 .2rem;}
.result-meta{font-size:.78rem;color:#9CA3AF;margin:0 0 1rem;}

/* Stats */
.stats-row{display:flex;gap:.6rem;margin:0 0 1.1rem;}
.stat-card{flex:1;background:white;border-radius:8px;padding:.75rem .4rem;text-align:center;border:1px solid #E5E7EB;}
.stat-card .stat-num{font-size:1.2rem;font-weight:700;color:#111;line-height:1;}
.stat-card .stat-lbl{font-size:.6rem;color:#9CA3AF;text-transform:uppercase;letter-spacing:1px;margin-top:.25rem;}

/* Download button */
[data-testid="stDownloadButton"]>button{
    background:#4B5563!important;color:white!important;border:none!important;
    border-radius:8px!important;padding:.65rem 1.25rem!important;
    font-family:'Inter',sans-serif!important;font-weight:600!important;
    font-size:.875rem!important;width:100%!important;transition:background .15s!important;
}
    ...
    for uploaded in uploaded_files:
        with st.spinner(f"Building {uploaded.name}…"):
            try:
                ...
                st.download_button(label="Download Report",data=xlsx_bytes,file_name=filename,
